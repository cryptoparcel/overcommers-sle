...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("price_monthly", sa.String(length=60), nullable=True, server_default=sa.text("'$1,100 / month'")),
        sa.Column("deposit", sa.String(length=60), nullable=True, server_default=sa.text("'$900 deposit'")),
